...
allowed-tools: Read, Write, Edit, Glob, Grep, Bash(ls:*), Bash(wc:*), Bash(date:*), Bash(mv:*), Bash(mkdir:*), WebFetch, WebSearch, Agent, mcp__roam-direct, mcp__roam, mcp__roam-wiki, mcp__roam-archive
---
